...
public class Robot extends TimedRobot {
	...
	{	
		...
		else if (stick.getRawButtonPressed(8) && position != 2)
		{
			if(position < 2)
			{
				while(pot.getVoltage() > 4.62)
					m.set(-.5);
			}
			else
			{
				while(pot.getVoltage() < 4.58)
					m.set(.3);
			}
			m.set(0);
			position = 2;
		...
		else if (stick.getRawButtonPressed(9) && position != 3)
		{
			if(position < 3)
			{
				while(pot.getVoltage() > 4.32)
					m.set(-.5);
			}
			else
			{
				while(pot.getVoltage() < 4.48)
					m.set(.3);
			}
			m.set(0);
			position = 3;
		...
		else if (stick.getRawButtonPressed(10) && position != 4)
		{
			if(position < 4)
			{
				while(pot.getVoltage() > 3.92)
					m.set(-.5);
			}
			else
			{
				while(pot.getVoltage() < 3.88)
					m.set(.3);
			}
			m.set(0);
			position = 4;
